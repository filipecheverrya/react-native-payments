...
Some of you may ask, why did you copy? Well, the author doesnt make the a properly manutention to this package So i picked up this and make it one especific bugfix that was bothering in the project that i work.

Everyone is able to relate others [issues](https://github.com/fripley/react-native-payments/issues) that has found and i'll be workin on it and accepting pull requests.
